...
/*
	★★★ プロジェクト内共通　★★★
*/
function getMaxItemFromHash(h: any, comp_prop: string, comp_as_string: boolean){
	var max_idx = -1;
	var max_val = comp_as_string ? "0" : 0;
	let list = convHash2Arr(h);
...
function handleIfreturn(ifr: IFRETURN, nav: NavigatorView){
...
/* 時間を文字列に変換 */
function formatDate(date, onlyYMD?: boolean, withSlash?: boolean){

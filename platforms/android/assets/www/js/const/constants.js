...
(function (VIEW_LABELS_MASTER) {
    ...
    VIEW_LABELS_MASTER.COL_MACHINE = "machine";
    VIEW_LABELS_MASTER.COL_HOME_IMG = "img";
    VIEW_LABELS_MASTER.COL_PRCS_DATE = "date";
    VIEW_LABELS_MASTER.COL_RPCS_PRICE = "price";
    VIEW_LABELS_MASTER.COL_CURR_ODD = "odd";
    VIEW_LABELS_MASTER.COL_MAIN_FLG = "main?";
